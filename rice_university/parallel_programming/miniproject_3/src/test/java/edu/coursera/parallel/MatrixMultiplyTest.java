...
public class MatrixMultiplyTest extends TestCase {
     ...
     */
    public void testPar768_x_768() throws Exception {
        // Force to use 4 worker. Default is number of CPU cores
        // System.setProperty("pcdp.numWorkers", "4");
        // Also, need to //        System.getenv().put("COURSERA_GRADER_NCORES", "4");
        ...
        for(Class<?> cl : classes) {
            if("java.util.Collections$UnmodifiableMap".equals(cl.getName())) {
                ...
                map.put("COURSERA_GRADER_NCORES", "4");
            }
        }

        // HDT added section end
