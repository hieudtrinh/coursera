Welcome Hieu Dai Trinh from Using Databases with Python

To get credit for this assignment, perform the instructions below and
upload your SQLite3 database here:
...
The expected result of the modified query on your database is: (shown here
as a simple HTML table with titles)