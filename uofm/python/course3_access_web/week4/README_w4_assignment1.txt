Welcome Hieu Dai Trinh from Using Python to Access Web Data
...
parse the data, extracting numbers and compute the sum of the numbers in
the file.
...
Actual data: http://py4e-data.dr-chuck.net/comments_911244.html (Sum ends with 11)
...
from the tag and sum the numbers. Look at the sample code provided. It shows
how to find all of a certain kind of tag, loop through the tags and extract
