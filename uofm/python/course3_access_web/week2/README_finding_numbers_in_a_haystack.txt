https://www.py4e.com/tools/python-data/?PHPSESSID=91cca4fd49114f7b57ce06544585b06c
...
Actual data: http://py4e-data.dr-chuck.net/regex_sum_911242.txt (There
are 78 values and the sum ends with 540)
These links open in a new window. Make sure to save the file into the
same folder as you will be writing your Python program. Note: Each student
will have a distinct data file for the assignment - so only use your own
